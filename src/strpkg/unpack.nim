...
proc unpack_file*(fs:FileStream, expected_format_version:int16=0, drop_unplaced:bool=false): tuple[targets: seq[Target], fragment_distribution: array[4096, uint32], reads: seq[tread]] =
  ...
  if softVersion != strlingVersion.asArray9():
    stderr.write_line &"[strling] WARNING: this bin file was generated by a different vertsion of STRling: {fmtVersion}. Current version is: {strlingVersion}."
